...
CUSTOM_MESSAGE_COUNT = Counter("custom_message_processed_total", "Total number of custom messages processed")
            ...
            async for message in queue_iter:
                async with message.process():
                    ...
                    try:
                        ...
                        CUSTOM_MESSAGE_COUNT.inc()  # Увеличить счётчик кастомных сообщений
